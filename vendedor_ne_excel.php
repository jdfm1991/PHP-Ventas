...
header("Content-Disposition: attachment; filename=Cuentas_Por_Cobrar_AJ_NE_".date('d-m-Y h:i a',time() - 3600*date('I')).".xls");
...
function volver(){
location.href = "index.php?page=vendedor&mod=1";
}
</script>
<?php
