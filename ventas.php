...
if (fechai != "" && fechaf != ""){
location.href="index.php?page=ventas_ver&mod=1&codvend="+codvend+"&fechai="+fechai+"&fechaf="+fechaf;
}else{
...
<p><strong>Desde
    <input name="fechai" id="fechai" value="01/<?php echo date("m/Y"); ?>" placeholder="dia/mes/anno" type="text" data-icon="search" class="date-input-css" /></strong></p>
	<p><strong>Hasta
    <input name="fechaf" value="<?php echo date("d/m/Y"); ?>" id="fechaf" placeholder="dia/mes/anno"  type="text" data-icon="search" class="date-input-css"  /></strong></p>	
