...
header("Content-Disposition: attachment; filename=Estado_Cuenta_Cliente_".date('d-m-Y h:i a',time() - 3600*date('I')).".xls");
...
$consulta = mssql_query("select * from saacxc where codclie='$codigo' and tipocxc='10' and saldo>0");
...
<table  width="auto" class="ui-btn-active" border="0">
  <tr>
    <td><h3>Cliente:<?php echo utf8_encode(mssql_result($name,0,"Descrip"))." ".mssql_result($name,0,"ID3"); ?></h3></td>
  </tr>
