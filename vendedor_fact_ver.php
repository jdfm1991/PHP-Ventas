...
echo round($dias);
 ...
 <tr class="ui-state-default">
  ...
  <tr class="ui-state-default">
   <td colspan="6"><strong> Monto Pendiente: <?php echo number_format($suma, 2, ",", "."); ?> Bs</strong></td> 
   </tr>
  </tbody> 
</table>
</div>
</br>
<a href="vendedor_fact_excel.php?&descrip=<?php echo $_GET['descrip']; ?>" target="_blank" > Imprimir en Excel</a> 
